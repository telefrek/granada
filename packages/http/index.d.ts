 ...
 */
export declare function emptyHeaders(): HttpHeaders;
/**
 ...
 */
export declare enum HttpRequestState {
 ...
 */
export declare function isFileContent(response: HttpResponse): response is FileContentResponse;
/**
